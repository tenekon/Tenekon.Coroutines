...
public class EffectResultGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        var methodComparer = TenekonEqualityComparerBuilder.ForElementsOf(methods)
        ...
        var methodStatementComparer = TenekonEqualityComparerBuilder.ForElementsOf(methodStatements)
        ...
        context.RegisterSourceOutput(invocations, (ctx, src) => {
            ...
            var allEffectResultClass = $$"""
                    public class {{workClass}} : global::Tenekon.Reactive.Coroutines.AsyncEffects.IAllEffectResult {
                        //private readonly static AllEffectResultProperty[] s_properties = new AllEffectResultProperty[] { {{metaProperties}} };
                    
                        //AllEffectResultProperty[] Tenekon.Reactive.Coroutines.AsyncEffects.IAllEffectResult.FirstLevelProperties => s_properties;
