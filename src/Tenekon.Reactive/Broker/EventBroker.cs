...
public record EventBroker : IEventBroker
{
    ...
    private protected virtual async Task EmitBacklogAsync<T>(EventEmissionBacklog emissionBacklog, EventId eventId, T eventData)
    {
    ...
    public Task EmitAsync<T>(EventId eventId, T eventData)
    {
        ...
        return EmitBacklogAsync(emissionBacklog, eventId, eventData);
    }
